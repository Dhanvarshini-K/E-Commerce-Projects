...
//   const renderShopProduct = shopProduct.documents.map(
//     (item: any, index: any) => {

//       console.log("item:", item.ActualPrice);
//       if (
...
//             discount_price={item.DiscounPrice}
...
//               {renderShopProduct}
//               {showMore ? renderShopProduct : null}
//             </div>
//           </div>
//         </div>
//       </section>
                      ...
                      {isActivePrice && (
                        <div className="dropdown-content border border-dark  d-flex flex-column gap-2 rounded p-2">
                          ...
                          <div className="dropdown-item text-center h5">
                            ...
                            >
                             <div onChange={() => handleCheckboxChange(300, 399.99)}> $300.00 - 399.99</div>
                            </Link>
                          </div>
                          <div className="dropdown-item text-center h5">
                            <Link
