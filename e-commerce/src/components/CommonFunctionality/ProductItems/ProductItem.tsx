...
//   likeWishList ?
//   (
//      <button className="border-0 bg-transparent" onClick={()=>setLikeWishList(!likeWishList)}>
//        <FontAwesomeIcon
//          icon={solidHeart}
//          className="rounded-circle p-2 text-danger shadow bg-light"
//        />
//      </button>
//    )
//   : (
...
//      <FontAwesomeIcon
//        icon={regularHeart}
//        className="rounded-circle p-2 text-secondary shadow bg-light"
//      />
//    </button>
//  )}
...
//   setLikeWishList(!likeWishList);
//   likeWishList ? addToWishList(props.id) : "";
// };
// <button className="border-0 bg-transparent" onClick={handleWishListButton}>
//   <FontAwesomeIcon
//     icon={likeWishList ? solidHeart : regularHeart}
//     className={`rounded-circle p-2 ${
//       likeWishList ? "text-danger" : "text-secondary"
